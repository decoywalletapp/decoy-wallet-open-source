...
export 'control_center_model.dart';

/// Create a “Control Center” settings page with three sections, each
/// separated visually.
///
/// Section 1: “Decoy PIN Triggers.” Include two switch options:
/// 	1.	“911 Trigger” – enable or disable the Decoy PIN calling emergency
/// services.
/// 	2.	“Emergency Contacts Trigger” – enable or disable the Decoy PIN sending
/// alerts to emergency contacts.
///
/// Section 2: “Decoy Seed.” Include one switch labeled “Seed Phrase Trap
/// (Armed / Disarmed).” When ON, the trap is considered armed; when OFF,
/// disarmed. This section also includes a second switch: “Emergency Contacts
/// Trigger” – enable or disable the Decoy Seed sending alerts.
///
/// Section 3: “Biometric Verification.” Include a single switch to enable or
/// disable biometric authentication.
///
/// At the bottom, include a Save button that confirms changes.
class ControlCenterWidget extends StatefulWidget {
  const ControlCenterWidget({super.key});

  static String routeName = 'ControlCenter';
  static String routePath = '/controlCenter';
...
class _ControlCenterWidgetState extends State<ControlCenterWidget> {
  late ControlCenterModel _model;
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      safeSetState(() {});
      _model.getBioPermissionResult =
          await actions.getBiometricPermissionStatus();
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if ((FFAppState().biometricsEnabled ==
                                          true) &&
                                      (_model.biometricPermissionGranted ==
                                          false))
                                    Align(
                                      alignment: AlignmentDirectional(0.0, 0.0),
                                      child: Column(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Material(
                                    color: Colors.transparent,
                                    child: SwitchListTile(
                                      value: _model.locationSwitchTileValue ??=
                                          FFAppState().locationEnabled,
                                      onChanged:
                                          (FFAppState().hasActiveSubscription ==
                                                  false)
                                  ...
                                  if ((FFAppState().locationEnabled == true) &&
                                      (_model.locationPermissionGranted ==
                                          false))
                                    Align(
                                      alignment: AlignmentDirectional(0.0, 0.0),
                                      child: Column(
