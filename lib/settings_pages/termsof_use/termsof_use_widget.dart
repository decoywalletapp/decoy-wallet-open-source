                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(16.0, 0.0, 16.0, 16.0),
                      child: Text(
                        'Your use of Decoy Wallet is also governed by our Privacy Policy.\n\nBy enabling emergency triggers, you consent to sharing certain information, which may include:\n• your name or profile information\n• your approximate or precise location (if allowed by your device)\n• your device data\n• the nature of the alert\n\nThis information may be shared with emergency service providers, public safety agencies, or third-party partners such as RapidSOS solely for the purpose of attempting to deliver emergency alerts.',
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              font: GoogleFonts.inter(
                                fontWeight: FlutterFlowTheme.of(context)
                                    .bodyMedium
