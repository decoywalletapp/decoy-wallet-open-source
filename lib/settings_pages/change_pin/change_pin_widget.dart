                                  ...
                                  if (_model.currentStep == 2)
                                    Align(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          if (_model.newPinInput.length >= 4) {
                                            _model.joinedNewPin =
                                                functions.newCustomFunction(
                                                    _model.newPinInput
                                                        .toList());
                                  ...
                                  if (_model.currentStep == 1)
                                    FFButtonWidget(
                                      onPressed: () async {
                                        _model.joinedOldPin =
                                            functions.newCustomFunction(
                                                _model.oldPinInput.toList());
                                        safeSetState(() {});
                                        if (_model.oldPinInput.length >= 4) {
                                          ...
                                          if (VerifyPINCall.ok(
                                            ...
                                            if (VerifyPINCall.isAccount(
                                              ...
                                              _model.joinedOldPin = '';
                                              safeSetState(() {});
                                              _model.oldpNotificationValue = 2;
                                              safeSetState(() {});
                                              await Future.delayed(
                                                Duration(
                                                  milliseconds: 2500,
                                          ...
                                          _model.joinedOldPin = '';
                                          safeSetState(() {});
                                          _model.oldpNotificationValue = 1;
                                          safeSetState(() {});
                                          await Future.delayed(
                                            Duration(
                                              milliseconds: 2500,
