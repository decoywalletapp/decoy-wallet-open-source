...
class _ChangePinWidgetState extends State<ChangePinWidget> {
  ...
  Widget _buildScrollableChangePinContent({
    required double bottomPadding,
    required Widget child,
  }) {
    return LayoutBuilder(
      builder: (context, constraints) {
        final minimumHeight = constraints.maxHeight > bottomPadding
  ...
  Widget build(BuildContext context) {
    ...
    final changePinBottomPadding = bottomClearance + 32.0;
                              ...
                              if (_model.currentStep == 3)
                                Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: _buildScrollableChangePinContent(
                                      bottomPadding: changePinBottomPadding,
                                      child: Padding(
