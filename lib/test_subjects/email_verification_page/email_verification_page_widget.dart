...
/// received as a email message to verify their phone number with their
/// account.
///
/// This code will check to make sure the user entered the verification code
/// sent to their email matches and proceeds if correct. Has the user re-enter
/// if incorrect, and also allows the user to send a new verification code to
/// their email if they need to do the process again.
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            'We\'ve sent a 6-digit verification code to your email address. Please enter it below to verify your phone number.',
                            textAlign: TextAlign.center,
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
