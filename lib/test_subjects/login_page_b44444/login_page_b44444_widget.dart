...
import 'login_page_b44444_model.dart';
export 'login_page_b44444_model.dart';

class LoginPageB44444Widget extends StatefulWidget {
  const LoginPageB44444Widget({
    super.key,
    this.type,
    this.accessToken,
    this.refreshToken,
  ...
  static String routeName = 'LoginPageB44444';
  static String routePath = '/loginPageB44444';

  @override
  State<LoginPageB44444Widget> createState() => _LoginPageB44444WidgetState();
}

class _LoginPageB44444WidgetState extends State<LoginPageB44444Widget> {
  late LoginPageB44444Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginPageB44444Model());
