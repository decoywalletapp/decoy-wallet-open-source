...
import 'auth_router_copy_model.dart';
export 'auth_router_copy_model.dart';

class AuthRouterCopyWidget extends StatefulWidget {
  const AuthRouterCopyWidget({
    super.key,
    this.type,
    this.accessToken,
    this.refreshToken,
  ...
  static String routeName = 'AuthRouterCopy';
  static String routePath = '/authRouterCopy';

  @override
  State<AuthRouterCopyWidget> createState() => _AuthRouterCopyWidgetState();
}

class _AuthRouterCopyWidgetState extends State<AuthRouterCopyWidget> {
  late AuthRouterCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthRouterCopyModel());
