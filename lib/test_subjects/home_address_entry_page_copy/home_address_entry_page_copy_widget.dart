...
import 'home_address_entry_page_copy_model.dart';
export 'home_address_entry_page_copy_model.dart';

/// create a page where the user enters their home address and then save
/// button at bottom
///
class HomeAddressEntryPageCopyWidget extends StatefulWidget {
  const HomeAddressEntryPageCopyWidget({super.key});

  static String routeName = 'HomeAddressEntryPageCopy';
  static String routePath = '/homeAddressEntryPageCopy';

  @override
  State<HomeAddressEntryPageCopyWidget> createState() =>
      _HomeAddressEntryPageCopyWidgetState();
}

class _HomeAddressEntryPageCopyWidgetState
    extends State<HomeAddressEntryPageCopyWidget> {
  late HomeAddressEntryPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeAddressEntryPageCopyModel());
