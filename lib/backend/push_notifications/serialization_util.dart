  ...
  try {
    ...
    switch (T) {
      ...
      case ArmedDecoySeedsRow:
        return ArmedDecoySeedsRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case DecoyWalletRow:
        return DecoyWalletRow(json.decode(param) as Map<String, dynamic>) as T;
      case DecoySeedScanStateRow:
        return DecoySeedScanStateRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case UserConsentsRow:
        return UserConsentsRow(json.decode(param) as Map<String, dynamic>) as T;
      case UserEntitlementsRow:
        return UserEntitlementsRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case RecoveryExchangeCodesRow:
        return RecoveryExchangeCodesRow(
            json.decode(param) as Map<String, dynamic>) as T;
      case DecoySeenTxsRow:
        return DecoySeenTxsRow(json.decode(param) as Map<String, dynamic>) as T;
      case DecoyTriggersRow:
        return DecoyTriggersRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case DecoySeedBaselinesRow:
        return DecoySeedBaselinesRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case EmergencyContactsRow:
        return EmergencyContactsRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case DecoysRow:
        return DecoysRow(json.decode(param) as Map<String, dynamic>) as T;
      case SmsQueueRow:
        return SmsQueueRow(json.decode(param) as Map<String, dynamic>) as T;
      case AlertLogsRow:
        return AlertLogsRow(json.decode(param) as Map<String, dynamic>) as T;
      case StripeEventsRow:
        return StripeEventsRow(json.decode(param) as Map<String, dynamic>) as T;
    }
    if (param is String) {
