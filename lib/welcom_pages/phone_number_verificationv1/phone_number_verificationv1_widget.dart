...
import 'phone_number_verificationv1_model.dart';
export 'phone_number_verificationv1_model.dart';
...
class PhoneNumberVerificationv1Widget extends StatefulWidget {
  const PhoneNumberVerificationv1Widget({
    super.key,
  ...
  static String routeName = 'PhoneNumberVerificationv1';
  static String routePath = '/phoneNumberVerificationv1';

  @override
  State<PhoneNumberVerificationv1Widget> createState() =>
      _PhoneNumberVerificationv1WidgetState();
}

class _PhoneNumberVerificationv1WidgetState
    extends State<PhoneNumberVerificationv1Widget> {
  late PhoneNumberVerificationv1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PhoneNumberVerificationv1Model());
