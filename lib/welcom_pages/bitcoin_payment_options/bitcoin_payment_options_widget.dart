...
import 'bitcoin_payment_options_model.dart';
export 'bitcoin_payment_options_model.dart';
...
class BitcoinPaymentOptionsWidget extends StatefulWidget {
  const BitcoinPaymentOptionsWidget({super.key});

  static String routeName = 'BitcoinPaymentOptions';
  static String routePath = '/bitcoinPaymentOptions';

  @override
  State<BitcoinPaymentOptionsWidget> createState() =>
      _BitcoinPaymentOptionsWidgetState();
}

class _BitcoinPaymentOptionsWidgetState
    extends State<BitcoinPaymentOptionsWidget> {
  late BitcoinPaymentOptionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BitcoinPaymentOptionsModel());
