                      ...
                      child: Column(
                        ...
                        children: [
                                  ...
                                  if (_model.currentStep == 2)
                                    Row(
                                      ...
                                      mainAxisAlignment:
                                          MainAxisAlignment.center,
                                      children: [
                                        if ((List<String> pinList2) {
                                          return pinList2.length >= 1;
                                        }(_model.confirmedPinInput.toList()))
                                          Align(
                                            alignment:
                                                AlignmentDirectional(0.0, 0.0),
                                            child: AnimatedContainer(
                            ...
                            child: GridView(
                              ...
                              children: [
                                FFButtonWidget(
                                  onPressed: () async {
                                    // Add1
                                    _model.addToConfirmedPinInput('1');
                                    safeSetState(() {});
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    // Add2
                                    _model.addToConfirmedPinInput('2');
                                    safeSetState(() {});
                                    if (_model.confirmedPinInput
                                            .toList()
                                            .length >
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    // Add3
                                    _model.addToConfirmedPinInput('3');
                                    safeSetState(() {});
                                    if (_model.pinInput.toList().length > 8) {
                                      _model.removeAtIndexFromConfirmedPinInput(
                                          _model.confirmedPinInput
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    // Add4
                                    _model.addToConfirmedPinInput('4');
                                    safeSetState(() {});
                                    if (_model.confirmedPinInput
                                            .toList()
                                            .length >
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    // Add5
                                    _model.addToConfirmedPinInput('5');
                                    safeSetState(() {});
                                    if (_model.confirmedPinInput
                                            .toList()
                                            .length >
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    // Add6
                                    _model.addToConfirmedPinInput('6');
                                    safeSetState(() {});
                                    if (_model.confirmedPinInput
                                            .toList()
                                            .length >
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    // Add7
                                    _model.addToConfirmedPinInput('7');
                                    safeSetState(() {});
                                    if (_model.confirmedPinInput
                                            .toList()
                                            .length >
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    // Add8
                                    _model.addToConfirmedPinInput('8');
                                    safeSetState(() {});
                                    if (_model.confirmedPinInput
                                            .toList()
                                            .length >
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    // Add9
                                    _model.addToConfirmedPinInput('9');
                                    safeSetState(() {});
                                    if (_model.confirmedPinInput
                                            .toList()
                                            .length >
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    // Add0
                                    _model.addToConfirmedPinInput('0');
                                    safeSetState(() {});
                          ...
                          if (_model.currentStep == 2)
                            FFButtonWidget(
                              onPressed: () async {
                                _model.joinedPin = functions.newCustomFunction(
                                    _model.pinInput.toList());
                                safeSetState(() {});
                                _model.joinedPinConfirm =
                                    functions.newCustomFunction(
                                        _model.confirmedPinInput.toList());
                                safeSetState(() {});
                                if (_model.confirmedPinInput.length >= 4) {
                                  if (_model.joinedPin ==
                                      _model.joinedPinConfirm) {
                                    FFAppState().userPIN = _model.joinedPin!;
                                    safeSetState(() {});
                                    _model.hashedPIN = await actions.hashPin(
                                      FFAppState().userPIN,
                                    );
                                    _model.pinWrite =
                                        await DecoyWalletTable().update(
                                      data: {
                                        'encrypted_pin': _model.hashedPIN,
                                      },
