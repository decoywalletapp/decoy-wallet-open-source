...
class _SettingsWidgetState extends State<SettingsWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final settingsSafeHeight =
        mediaQuery.size.height - mediaQuery.padding.vertical;
    final useCompactSettingsLayout = settingsSafeHeight < 840.0;
    final settingsSectionGap = useCompactSettingsLayout ? 16.0 : 24.0;
    final settingsContentGap = useCompactSettingsLayout ? 10.0 : 16.0;
    final settingsRowHeight = useCompactSettingsLayout ? 56.0 : 60.0;
    final settingsRowPadding = useCompactSettingsLayout ? 14.0 : 16.0;
    final settingsBackTopPadding = useCompactSettingsLayout ? 4.0 : 8.0;
    final settingsSocialBottomPadding = useCompactSettingsLayout ? 4.0 : 10.0;
    final settingsScrollBottomPadding = useCompactSettingsLayout ? 24.0 : 32.0;
          ...
          body: SafeArea(
            child: SingleChildScrollView(
              ...
              padding: EdgeInsetsDirectional.fromSTEB(
                  0.0, 0.0, 0.0, settingsScrollBottomPadding),
              child: Column(
