...
echo "Publishing Decoy Wallet entitlement-safety mobile update..."
echo "Repository: $REPO"
echo "Current branch: $(git branch --show-current)"
echo "Starting commit: $(git rev-parse HEAD)"
echo "Baseline before this fix: 61a1c44509412f34ed1b5c18342ab78790ce769b"
...
git add \
  ...
  lib/settings_pages/manage_subscription/manage_subscription_widget.dart \
  lib/welcom_pages/payment_return/payment_return_model.dart \
