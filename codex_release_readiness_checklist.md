...
9. Display accessibility stress test
   ...
   - Code polish added: Home page Decoy Contacts tile now bounds its fake-bold text stack inside a fixed-width container so the wider offset stays readable on larger layouts.
