...
echo "Publishing Decoy Wallet legal documents update..."
...
echo "Done. Legal documents TestFlight build started."
echo "Next: install TestFlight, then check onboarding Agreements and Settings legal pages."
